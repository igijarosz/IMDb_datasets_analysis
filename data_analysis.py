...
def analyze_runtime_distribution(df, output_dir):
...
def analyze_genre(df, output_dir):
    # === 3. Genre analysis ===
...
def analyze_golden_age(df, output_dir):
...
def analyze_popularity_vs_rating(df, output_dir):
...
def analyze_directors_ranking(df):
    # === 6. Directors ranking ===
...
def run_all_analyses(csv_path, output_dir):
...
if __name__ == "__main__":
    run_all_analyses('processed_data/movies_processed.csv', "analysis/charts/charts_all_movies")
    run_all_analyses('processed_data/top_1000_movies.csv', "analysis/charts/charts_top_1000_movies")